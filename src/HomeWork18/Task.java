...
public class Task {
    /*Create a Class Computer that will have 4 subclasses as Apple,
     ...
     in parent class and override some methods in child classes
     Define some methods specific to child classesCreate objects of
     child classes and store them into array. Loop through each object
